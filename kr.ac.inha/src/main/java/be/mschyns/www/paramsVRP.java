...
public class paramsVRP {
  ...
  public boolean serviceInTW, debug = false;
  ...
  public void initParams(String inputPath) throws IOException {
    ...
    try {
      ...
      Path pt = new Path(
          //* TODO: modify below to proper url of hdfs *//
          "hdfs://[hdfs-server-ip]:9000/user/[sever-user-name]/" + inputPath);
